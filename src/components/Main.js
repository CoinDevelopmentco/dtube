        ...
        <div className="row">
          <div className="col-md-10">
            <div className="embed-responsive embed-responsive-16by9" style={{ maxHeight: '768px'}}>
              <video
                src={`https://ipfs.infura.io:5001/api/v0/cat?arg=${this.props.currentHash}`}
                controls
                ></video>
            </div>
          ...
          <div className="col-md-2 overflow-auto text-center" style={{ maxHeight: '768px', minWidth: '175px' }}>
            ...
            <form onSubmit={(event) => {
              ...
              &nbsp;
              <input type='file' accept=".mp4, .mkv .ogg .wmv .flac" onChange={this.props.captureFile} style={{ width: '250px' }} />
